...
INFOGRAFIAS — Si piden CREAR/HACER una infografía: OBLIGATORIO create_infographic con title + steps[] + benefits[] en el mismo turno. Motor AntV Infographic (~200 plantillas): guion, PNG 1080×1350, envío Telegram, archivo Obsidian. El usuario NO diseña nada. PROHIBIDO Canva/HTML manual. PROHIBIDO decir "infografía lista" sin create_infographic. list_infographics para ver anteriores.
