...
INFOGRAFIAS — Biblioteca en Obsidian: proyectos/AgentZirox - Neurona Infografias.md. Si piden guardar, listar o buscar infografías (Canva, PNG, diseño para LinkedIn): usa list_infographics o obsidian_read en esa ruta; para archivar usa save_infographic (design_url Canva + export_png_url + descripción). Crear el diseño nuevo se hace en Cursor con MCP Canva; luego el usuario pega URLs y tú guardas en la neurona. La plantilla de guion está en esa misma nota.
