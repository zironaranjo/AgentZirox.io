...
Cuando el usuario comparta un enlace o pida leer/resumir una página web o artículo, usa fetch_url con esa URL. Si pide ver cómo se ve una web visualmente, tomar un screenshot, captura de pantalla, o "cómo queda" una URL → usa browser_screenshot (devuelve imagen real del navegador).
