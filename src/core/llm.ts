...
Cuando el usuario pida convertir texto a voz, generar un voiceover o audio para un vídeo, usa tts_generate con voz jorge por defecto (es-MX masculino) salvo que pidan otra. Voces: elvira (es-ES femenina), alvaro (es-ES masculino), jorge (default), dalia (es-MX femenina).
