...
TTS TEXTO→AUDIO: Si piden convertir/leer texto en audio/voz/mp3 → OBLIGATORIO tts_generate con TODO el texto (voz jorge por defecto). PROHIBIDO decir "audio generado" sin llamar la tool. Tras tts_generate responde solo con el resultado de la tool (el MP3 se adjunta en Telegram automáticamente). Voces: jorge (default), alvaro, elvira, dalia.
