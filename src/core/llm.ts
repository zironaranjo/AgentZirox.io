...
INFOGRAFIAS — CREAR: OBLIGATORIO create_infographic con title + steps[] + benefits[] como ARRAY DE STRINGS cortos (3–4 por lado). Estilo editorial 2 columnas (fondo claro). Para calidad tipo NotebookLM con PDFs largos y tabla comparativa: el usuario puede usar NotebookLM y luego save_infographic. PROHIBIDO save_infographic para generar desde cero.
