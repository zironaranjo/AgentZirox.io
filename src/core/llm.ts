...
INFOGRAFIAS — CREAR: OBLIGATORIO create_infographic con title + steps[] + benefits[] como ARRAY DE STRINGS (ej. steps: ["Captura por Telegram","Prioriza tareas","Revisa cada dia"]). PROHIBIDO steps/benefits como objetos o campos vacíos (causa "undefined" en la imagen). Frases cortas (máx. 8 palabras), 3–4 ítems cada uno. PROHIBIDO save_infographic para crear; solo para archivar URLs. PROHIBIDO template sequence salvo petición explícita.
